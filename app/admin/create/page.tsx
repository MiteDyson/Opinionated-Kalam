...
export default function CreatePage() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: BG, color: TEXT, display: "flex", flexDirection: "column" }}>
      ...
      {/* Top bar */}
      <div style={{ backgroundColor: TEXT, padding: "0 28px", display: "flex", alignItems: "center", gap: 14, height: 52 }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 24px" }}>
        <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "2.2rem", color: TEXT, marginBottom: 8, textAlign: "center" }}>
          What are you creating?
        </h1>
        <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.88rem", color: MUTED, marginBottom: 48, textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap", justifyContent: "center", maxWidth: 780 }}>
          {OPTIONS.map(opt => (
            <button
              ...
              style={{
                width: 220, padding: "32px 24px 28px",
            ...
            >
              ...
              <span style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: TEXT }}>{opt.label}</span>
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.78rem", color: MUTED, lineHeight: 1.5 }}>{opt.desc}</span>
              <span style={{ marginTop: 4, padding: "5px 16px", borderRadius: 20, backgroundColor: opt.accent, color: "white", fontSize: "0.75rem", fontWeight: 700, fontFamily: "'Inter', sans-serif" }}>
                Create →
              </span>
            </button>
          ))}
