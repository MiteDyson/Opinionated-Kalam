      ...
      <header style={{ backgroundColor: "var(--bg)", paddingBottom: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 16px", borderBottom: "1px solid var(--border)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            {/* Instagram */}
            <a href="#" style={{ display: "flex", color: "#1A1A1A" }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="5"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
            </a>
            {/* X/Twitter */}
            <a href="#" style={{ display: "flex", color: "#1A1A1A" }}>
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 26, height: 26, borderRadius: "50%", backgroundColor: "#FF0000", color: "white", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 16px", borderBottom: "1px solid var(--border)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <div style={{ display: "flex", gap: 0, overflowX: "auto", scrollbarWidth: "none" }}>
              ...
              <div className="mobile-tabs" style={{ display: "flex", gap: 0 }}>
                {TABS.map(tab => (
                  <button
                    key={tab.id}
