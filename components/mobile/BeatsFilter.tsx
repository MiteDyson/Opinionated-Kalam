...
export default function BeatsFilter({
  selectedBeat,
  onBeatChange,
}: BeatsFilterProps) {
  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      ...
      >
        ...
        {/* Caret: right-pointing ‹ when closed, points down ‹ rotated when open */}
        <span
          style={{
            fontSize: "0.6rem",
            ...
            {ALL_BEATS.map(beat => (
              <li
                ...
                style={{
                  ...
                  fontSize: "0.8rem",
                  padding: "7px 16px",
                  color: selectedBeat === beat ? BLACK : "#333",
                  fontWeight: selectedBeat === beat ? 600 : 400,
                  cursor: "pointer",
                  backgroundColor:
                    selectedBeat === beat ? "#f5f0eb" : "transparent",
                }}
                onMouseEnter={e =>
